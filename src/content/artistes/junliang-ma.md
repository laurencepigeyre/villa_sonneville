...
sections:
  - tab_label: Œuvres
    ...
    artworks:
      ...
      - layout: alternating
        ...
        year: '2026'
        technique: Grès, porcelaine, plâtre
        dimensions: 26 x 17 x 24 cm
        reference: JM-C09
        price: 1 500 €
      - layout: alternating
      ...
      - layout: alternating
        ...
        technique: Grès, porcelaine
        dimensions: 14 x 17 x 8 cm (environ)
        reference: JM-C17
        price: 70 €
      - layout: alternating
        ...
        title: Grande coupe
        technique: Grès
        dimensions: 24 x 28 x 8 cm (environ)
        reference: JM-C18
        price: Vendue
      - layout: alternating
      ...
      - layout: alternating
        ...
        year: ''
        technique: Grès
        dimensions: 35 x 38 x 11 cm (environ)
        reference: JM-C19
        price: Vendue
        contact_url: ''
      - layout: alternating
  ...
  - tab_label: Biographie
    intro_text: |-
      ...
      Né en 1986 en Chine, Junliang Ma est diplômé de l'Académie des Beaux-Arts de Chine (Hangzhou) en 2008. Après avoir fondé son premier atelier à Hangzhou en 2014, il s'installe à Strasbourg où il vit et travaille aujourd'hui.

      Sa création s'enracine dans la céramique chinoise traditionnelle, dont il a patiemment maîtrisé les techniques — pétrissage de l'argile, tournage, courbes de cuisson au gaz, étude comparative des formes représentatives des différentes dynasties. De cet apprentissage rigoureux, il dit avoir acquis « la capacité d'entendre la parole du matériau ».

      Sa recherche sur les émaux constitue le cœur de son travail : à partir du céladon, l'émail le plus emblématique de la tradition chinoise, il en étend peu à peu le spectre — blanc cyan, céladon ciel, vert carapace de crabe, ocre bambou, rouge kaki, bleu jade, taches brunes, noir huilé. Ses sculptures explorent la limite entre dispersion et cohésion, entre fragment et totalité, et donnent à la céramique une vitalité résolument contemporaine.

      Lauréat de plusieurs prix récents, il a notamment été distingué au Marché des potiers de Melun et au Festival Bandol Céramique en 2025.

      ### Sélection d'expositions et prix

      #### 2025
      - 13ᵉ édition du salon Résonances, Strasbourg
      - Salon d'art en artisans, Montigny-lès-Metz
      - 21ᵉ édition du salon C14 Paris
      - Prix du jury — Marché des potiers, Melun
      - Prix « Lumière sur 2025 » Solargil — Festival Bandol Céramique

      #### 2024
      - 12ᵉ édition du salon Résonances, Strasbourg
      - 20ᵉ édition du salon C14 Paris
      - Terralha, Festival Européen de Céramique, Saint-Quentin-la-Poterie
      - Exposition « Sortie de résidence », Saint-Quentin-la-Poterie

      #### 2023
      - Résidence à Saint-Quentin-la-Poterie

      #### 2019 – 2021
      - Exposition personnelle 《青山重》, Wan gallery, Shanghai (2021)
      - Exposition personnelle 《青绿间 浅斟低唱》, Melfish gallery, Pékin (2020)
      - Exposition personnelle 《餐桌上的青瓷》 (« Céladon sur la table »), Wan gallery, Shanghai (2019)

      #### 2012 – 2013
      - Young Talents, Messe Frankfurt (Allemagne)
      - Exposition d'ouverture du Musée d'art de l'Himalaya, Shanghai
      - 8ᵉ Biennale des jeunes artistes — céramistes chinois contemporains, Hangzhou
---
