...
sort_order: 999
quote_text: |-
  De maîtrise technique, il en est question à propos des
  céramiques réalisées par Jean Claude Legrand. La première
  image qui jaillit est celle de la pierre, alors qu'il s'agit de terre.
  Le trompe-l'œil n'est cependant pas tromperie, mais
  accélération de ce qui se produit, à l'échelle des temps
  géologiques, dans les métamorphoses des roches.
  La géologie n'est pas loin…
quote_author: Extrait d'un texte de Bruno Lestarquit
sections:
  - tab_label: ''
    section_title: Carrés de Terre
    intro_image_alt: ''
    intro_subtitle: Exposition Le Fil Rouge, Roubaix
    intro_text: ''
    cta_label: ''
    cta_url: ''
    artworks:
      - layout: alternating
        ...
        year: '2025'
        technique: Oxydes et engobes sur grès
        dimensions: 43 x 39 x 14 cm
        reference: JCL-C01
        price: 3 200€
      - layout: alternating
      ...
      - layout: alternating
        ...
        year: '2025'
        technique: Oxydes et engobes sur grès
        dimensions: 49,5 x 41 x 11,5 cm
        reference: JCL-C07
        price: 2 800€
      - layout: alternating
